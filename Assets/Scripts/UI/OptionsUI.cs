...
public class OptionsUI : MonoBehaviour
{
    ...
    private void Start()
    {
        KitchenGameManager.Instance.OnLocalGameUnpaused += KitchenGameObject_OnGameUnpaused;
    ...
    private void KitchenGameObject_OnGameUnpaused(object sender, System.EventArgs e)
    {
        Hide();
    }
