...
public class SoundManager : MonoBehaviour
{
    ...
    public static event System.EventHandler OnVolumeChanged;
    ...
    private void PlaySound(AudioClip audioClip, Vector3 position, float volumeMultiplier = 0.5f)
    {
    ...
    public void ChangeVolume()
    {
        ...
        OnVolumeChanged?.Invoke(this, System.EventArgs.Empty);
    }
